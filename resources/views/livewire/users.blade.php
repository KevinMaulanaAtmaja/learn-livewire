<div class="flex justify-center gap-10">
    <div class="w-1/3 my-10">
        ...
        <div class="py-2">
            ...
            @if (session('success'))
                <div class="p-4 mb-4 mt-6 text-sm text-green-800 rounded-lg bg-green-50" role="alert">
                ...
                <form wire:submit.prevent="createNewUser" method="POST" class="space-y-6">
                    <div>
                        ...
                        <div class="mt-2">
                            ...
                            @error('name')
                                <p class="mt-2.5 text-xs text-red-600"><span class="font-medium">{{ $message }}
                                </p>
                            @enderror
                        </div>
                    </div>
                                ...
                                <div class="mt-4 flex text-sm/6 text-gray-600">
                                    <label for="avatar"
                                        ...
                                        <input wire:model="avatar" id="avatar" type="file" name="avatar"
                                            class="sr-only" accept="image/png, image/jpeg, image/gif, image/jpg" />
                                    </label>
                    ...
                    @if ($avatar)
                        ...
                        <img src="{{ $avatar->temporaryUrl() }}" alt="{{ $avatar }}"
                            class="rounded w-20 h-20 block object-cover">
                    @endif
                    ...
                    <div>
                        <button wire:click.prevent="createNewUser"
                            ...
                            <svg wire:loading wire:targer="createNewUser" aria-hidden="true"
                                class="w-4 h-4 me-2 self-center text-gray-200 animate-spin fill-blue-600"
            ...
            @foreach ($users as $user)
                <li class="flex justify-between gap-x-6 py-5">
                    <div class="flex min-w-0 gap-x-4">
                        <img src="{{ $user->avatar ? Storage::url($user->avatar) : asset('img/default-pic.png') }}"
                    ...
                    <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                        <p class="self-center mt-1 text-xs/5 text-gray-500">Joined <time
